...
public class GuiPaddock extends GuiContainer
{
    /**
     * The resource location of the GUI background.
     */
    private static final ResourceLocation TEXTURE = new ResourceLocation(Constants.MOD_ID, "textures/gui/paddock.png");
     ...
     */
    private final PaddockTileEntity tileEntity;
     ...
     */
    protected GuiPaddock(final InventoryPlayer parInventoryPlayer, final PaddockTileEntity tileEntity, final World world, final BlockPos location)
    {
        super(new Paddock(tileEntity, parInventoryPlayer, world, location));
