...
public class Paddock extends Container
{
  ...
  // :TODO: rbenning : Verschiedene Typen für die verschiedenen Tiere. Aktuell nur Schweine implementiert
     ...
     */
    private Paddock(final Colony colony)
    {
        super();
        this.colony = colony;
    }
     ...
     * @return {@link Paddock} created from the compound.
     */
    @NotNull
    public static Paddock createFromNBT(final Colony colony, @NotNull final NBTTagCompound compound)
    {
        @NotNull final Paddock field = new Paddock(colony);
