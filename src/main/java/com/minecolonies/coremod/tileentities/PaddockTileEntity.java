 ...
 */
public class PaddockTileEntity extends TileEntityChest
{
    /**
     ...
     */
    private String name = LanguageHandler.format("com.minecolonies.coremod.gui.paddock.user", LanguageHandler.format("com.minecolonies.coremod.gui.paddock.user.noone"));

    /**
     * Creates an instance of the tileEntity.
     */
    public PaddockTileEntity()
    {
        super();
    ...
    public void onLoad()
    {
        ...
        if (colony != null && colony.getField(pos) == null)
        {
            ...
            {
                colony.addNewPaddock(this, ((EntityPlayer) entity).inventory, pos, world);
            }
        }
    }
