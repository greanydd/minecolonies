...
public class WindowHutShepherd extends AbstractWindowWorkerBuilding<BuildingShepherd.View>
{
     ...
     */
    private static final String HUT_SHEPHERD_RESOURCE_SUFFIX = ":gui/windowhutshepherd.xml";
     ...
     *
     * @param building {@link com.minecolonies.coremod.colony.buildings.BuildingShepherd.View}.
     */
    public WindowHutShepherd(final BuildingShepherd.View building)
    {
        super(building, Constants.MOD_ID + HUT_SHEPHERD_RESOURCE_SUFFIX);
    ...
    private void assignClicked(@NotNull final Button button)
    {
        ...
        final PaddockView field = fields.get(row);
    ...
    public void onOpened()
    {
        ...
        fieldList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            {
                final PaddockView field = fields.get(index);
