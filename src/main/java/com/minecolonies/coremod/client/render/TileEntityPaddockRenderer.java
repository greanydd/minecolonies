...
public class TileEntityPaddockRenderer extends TileEntitySpecialRenderer<PaddockTileEntity>
{
    /**
     ...
     */
    public TileEntityPaddockRenderer()
    {
        super();
    ...
    @Override
    public void renderTileEntityAt(@NotNull final PaddockTileEntity te, final double posX, final double posY, final double posZ, final float partialTicks, final int destroyStage)
    {
    ...
    /**
     * Returns the ResourceLocation of the paddock texture.
     *
     * @param tileEntity the tileEntity of the paddock.
     * @return the location.
     */
    @NotNull
    private static ResourceLocation getResourceLocation(@NotNull final PaddockTileEntity tileEntity)
    {
        final String loc = "textures/blocks/blockpaddock.png";
