 ...
 */
public class BlockHutPaddock extends BlockContainer
{
    /**
     ...
     */
    private static final String REGISTRY_NAME = "blockHutPaddock";
    ...
    private void initBlock()
    {
        ...
        setUnlocalizedName(Constants.MOD_ID.toLowerCase() + "." + "blockHutPaddock");
    ...
    public void onBlockPlacedBy(@NotNull final World worldIn, @NotNull final BlockPos pos, final IBlockState state, final EntityLivingBase placer, final ItemStack stack)
    {
        ...
        if (placer instanceof EntityPlayer)
        {
            ...
            if (colony != null)
            {
                ...
                final PaddockTileEntity scareCrow = (PaddockTileEntity) worldIn.getTileEntity(pos);
                final EntityPlayer player = (EntityPlayer) placer;
                if (scareCrow != null)
                {
                    scareCrow.setInventoryField(inventoryField);
                    colony.addNewPaddock(scareCrow, player.inventory, pos, worldIn);
                }
            }
        }
    }
